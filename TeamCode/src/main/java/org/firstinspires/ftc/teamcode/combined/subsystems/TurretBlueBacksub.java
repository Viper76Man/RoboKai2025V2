...
public class TurretBlueBacksub implements Subsystem {
    public static final TurretBlueBacksub Instance = new TurretBlueBacksub();

    private TurretBlueBacksub() {
    }
    ...
    // 8
    private static final double txOffsetBack = 10.15;
    // Playing with this number
